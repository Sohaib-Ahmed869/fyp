...
const BranchAdd = () => {
  ...
  const handleSubmit = (e) => {
    ...
    AdminService.addBranch({
      ...
      console.log(res);
      if (res === "error") alert("Error adding branch");
      else {
      ...
      <div className="grid md:grid-cols-2 md:gap-6">
        ...
        <div className="relative z-0 w-full mb-5 group">
          <input
            ...
            required
            onChange={(e) =>
              setBranch({ ...branch, total_tables: e.target.value })
            }
        ...
        <div className="flex justify-between">
          <div className="relative z-0 w-full mb-5 group">
            <input
              ...
              required
              onChange={(e) =>
                setBranch({ ...branch, card_tax: e.target.value })
              }
        ...
        <div className="relative z-0 w-full mb-5 group">
          <input
            ...
            placeholder=" "
            required
            onChange={(e) => setBranch({ ...branch, cash_tax: e.target.value })}
